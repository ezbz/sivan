...
var tagMappingsConfig = revisionUtils.createTagMapperFromConfig(config.svn.tagMappings);
var fileMappingsConfig = revisionUtils.createFileMapperFromConfig(config.svn.fileMappings);
    ...
    function(callback) {
      svnClient.serverInfo(function(serverInfoErr, info) {
        ...
        esClient.maxId({
          ...
          var maxIndexedId = (searchResult.hits && searchResult.hits.hits[0]) ? searchResult.hits.hits[0]._id : 0;
